...
En esta sección se especifican las épicas y las User Stories que definen el alcance funcional de Entreprenly. Se conservan los identificadores del producto original para mantener la trazabilidad. Primero se presentan las épicas y las historias que agrupan; luego se detalla cada historia con usuario, prioridad, épica, título, descripción y criterios de aceptación.
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><td colspan="4"><strong>Escenario 1: Agregar producto unitario correctamente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando proporciona nombre, descripción, precio por unidad, stock inicial, categoría y tipo "unitario" y solicita "Guardar",<br>Entonces el producto se registra en el inventario y queda registrado y disponible con tipo "Unit Product".<br><br><strong>Escenario 2: Agregar producto por peso correctamente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando selecciona tipo "por peso" e proporciona precio por kg y stock en kg,<br>Entonces el producto se registra y queda registrado y disponible con tipo "Weight Product" mostrando el stock en kilogramos.<br><br><strong>Escenario 3: Validación de dato obligatorios</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando omite los datos obligatorios y solicita "Guardar",<br>Entonces el sistema identifica cada dato faltante con el mensaje "Este dato es obligatorio" y no registra el producto.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Editar lote correctamente</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando modifique los datos correctamente y solicita "Guardar",<br>Entonces los cambios del lote se actualizan exitosamente.<br><br><strong>Escenario 2: Validación al editar lote</strong><br>Dado que el usuario está editando un lote,<br>Cuando proporcione datos inválidos o omite los datos obligatorios y solicita "Guardar",<br>Entonces el sistema informa mensajes de error y no guardará los cambios.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Agregar lote correctamente</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando proporcione una cantidad y fecha válida y solicita "Agregar",<br>Entonces el nuevo lote se agrega exitosamente.<br><br><strong>Escenario 2: Intento de registro de lote con información incompleta</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando intenta procesar la solicitud dejando uno o más dato obligatorios vacíos,<br>Entonces el sistema debe impedir el registro y resaltar cada dato omitido con el mensaje: "Este dato es obligatorio".</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Eliminar lote correctamente</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita "Eliminar",<br>Entonces el lote se elimina exitosamente.<br><br><strong>Escenario 2: Validación al eliminar lote</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita "Eliminar",<br>Entonces saldrá un mensaje de error de no haber seleccionado un lote.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Producto editado correctamente</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita "Editar",<br>Entonces el producto se actualiza exitosamente.<br><br><strong>Escenario 2: Validación al editar productos</strong><br>Dado que el usuario se encuentra en la lista de inventario y ha seleccionado un producto existente,<br>Cuando el usuario intenta cambiar el "Tipo de Producto" y solicita el acción de guardar,<br>Entonces el sistema debe impedir la acción y mostrar un mensaje de error indicando: "Este dato no se puede modificar".</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Detalles de lote mostrados correctamente</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita "Ver Detalles",<br>Entonces los detalles se informan exitosamente.<br><br><strong>Escenario 2: Error al recuperar los detalles del lote</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando el usuario solicita "Ver Detalles" pero ocurre un error de comunicación con el servidor (timeout o error 500),<br>Entonces el sistema debe mostrar un mensaje de error indicando: "No se pudieron cargar los detalles en este momento. Inténtelo más tarde".</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Visualización de información del producto</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando se carga la información,<br>Entonces cada producto debe mostrar: tipo, nombre, descripción, código QR, stock total y precio.<br><br><strong>Escenario 2: Manejo de información incompleta del producto</strong><br>Dado que un producto no cuenta con algún dato,<br>Cuando se carga la información,<br>Entonces el sistema muestra los datos disponibles y los dato faltantes aparecen como "-".</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Búsqueda de productos por nombre</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando proporciona el nombre de un producto en el dato de búsqueda,<br>Entonces el sistema filtra y muestra los productos que coincidan.<br><br><strong>Escenario 2: Búsqueda de productos por categoría</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando selecciona o proporciona una categoría,<br>Entonces el sistema filtra y muestra los productos de esa categoría.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Creación de lote exitosa</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita "Crear Lote", selecciona un producto y completa los datos correctamente,<br>Entonces el sistema registra el nuevo lote y lo muestra en la lista.<br><br><strong>Escenario 2: Validación al crear lote</strong><br>Dado que el usuario no selecciona un producto o proporciona datos incompletos,<br>Cuando intenta guardar el lote,<br>Entonces el sistema muestra mensajes de error y no permite su creación.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Escaneo de QR exitoso</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita el acción con ícono de cámara y escanea un código QR válido,<br>Entonces el sistema completa el dato de código QR con el valor detectado y finaliza la lectura del código.<br><br><strong>Escenario 2: Permiso de cámara denegado</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando el sistema operativo deniega el permiso de acceso a la cámara,<br>Entonces el sistema muestra el mensaje de permiso denegado y no modifica el dato de código QR.<br><br><strong>Escenario 3: Cámara no disponible</strong><br>Dado que el usuario intenta abrir el escáner y el dispositivo no permite iniciar la cámara,<br>Cuando el sistema recibe el error,<br>Entonces muestra el mensaje "No se pudo acceder a la cámara" y permite cerrar el resumen.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Alerta de stock próximo a agotarse</strong><br>Dado que uno o más productos tienen stock total mayor a cero pero igual o menor a 5 unidades o kilogramos,<br>Cuando el usuario solicita el acción de campana de alertas en el resumen móvil de lotes,<br>Entonces el sistema informa una alerta de stock bajo indicando el número de lotes a punto de quedarse sin stock, junto con el producto y el lote afectados.<br><br><strong>Escenario 2: Alerta de stock agotado</strong><br>Dado que uno o más lotes tienen cantidad igual a cero o un producto no tiene stock en ninguno de sus lotes,<br>Cuando el usuario accede al resumen móvil de lotes,<br>Entonces el indicador "Sin Stock" muestra el número de casos agotados y el resumen de alertas lista cada lote sin stock indicando el producto afectado.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Alertas de estado mostradas en el detalle</strong><br>Dado que el producto consultado tiene lotes con stock bajo, agotados, vencidos o próximos a vencer,<br>Cuando el usuario solicita "Ver detalles",<br>Entonces el sistema informa alertas agrupadas por tipo y una lista de lotes; los lotes vencidos se identifican con la etiqueta "Vencido" y la fecha de caducidad resaltada.<br><br><strong>Escenario 2: Sin alertas si el estado es normal</strong><br>Dado que los lotes del producto no presentan condiciones críticas,<br>Cuando el usuario solicita "Ver detalles",<br>Entonces el sistema muestra la lista de lotes sin alertas ni etiquetas de estado crítico.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Visualización de resumen de lotes</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando se carga la información,<br>Entonces se muestran los indicadores "Total de Lotes" (contando solo lotes asociados a productos existentes), "Lotes Vencidos" y "Sin Stock", las resúmenes por producto con su stock total y número de lotes registrados, y el acción de campana con el contador de alertas activas.<br><br><strong>Escenario 2: Sin alertas si no hay condiciones críticas</strong><br>Dado que no existen lotes vencidos, agotados, con stock bajo ni próximos a vencer,<br>Cuando se carga el resumen móvil,<br>Entonces el contador de la campana no se muestra y, al abrir el resumen de alertas, se indica el mensaje "No hay alertas pendientes.".</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Notificación de lote próximo a vencer</strong><br>Dado que uno o más lotes vencerán dentro de los próximos 5 días y el usuario autorizó las notificaciones,<br>Cuando el sistema procesa las fechas de caducidad,<br>Entonces envía una notificación push que indica el producto afectado, los días restantes y la fecha de vencimiento.<br><br><strong>Escenario 2: Alerta de lote vencido dentro de la aplicación</strong><br>Dado que uno o más lotes tienen una fecha de caducidad anterior a la fecha actual,<br>Cuando el usuario abre el resumen de alertas,<br>Entonces se muestra una alerta de lotes vencidos con el producto y la fecha correspondiente, se le asigna la mayor prioridad y el indicador "Lotes Vencidos" refleja el total.<br><br><strong>Escenario 3: acceso desde la alerta al lote afectado</strong><br>Dado que el usuario selecciona una notificación o una alerta de caducidad,<br>Cuando Entreprenly procesa la acción,<br>Entonces abre el detalle de los lotes del producto afectado para que pueda revisar o gestionar el lote correspondiente.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Selección de plan realizada correctamente</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando selecciona el plan Control,<br>Entonces el sistema registra el plan seleccionado, marca el plan como seleccionado y permite continuar con la suscripción.<br><br><strong>Escenario 2: Intento de continuar sin seleccionar un plan</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando intenta continuar sin un plan seleccionado,<br>Entonces el sistema no permite avanzar y muestra un mensaje indicando que debe seleccionar un plan primero.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Proceso de suscripción iniciado correctamente</strong><br>Dado que el usuario ya seleccionó el Plan Control,<br>Cuando continúa con la suscripción,<br>Entonces el sistema registra el inicio del proceso y lo redirige al datos de facturación.<br><br><strong>Escenario 2: Intento sin plan seleccionado</strong><br>Dado que el usuario no ha seleccionado un plan,<br>Cuando continúa con la suscripción,<br>Entonces el sistema no permite iniciar el proceso y muestra un mensaje solicitando seleccionar un plan primero.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Datos de facturación registrados correctamente</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando el sistema valida la información,<br>Entonces registra los datos y habilita el resumen previo al cobro.<br><br><strong>Escenario 2: Datos de facturación inválidos</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita la operación «Continuar al pago»,<br>Entonces el sistema no registra la información, identifica los datos con error y muestra un mensaje de validación.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Cobro procesado exitosamente</strong><br>Dado que el usuario ya registró correctamente sus datos de facturación,<br>Cuando solicita la operación «Pagar y activar suscripción» y el cobro es aprobado,<br>Entonces el sistema registra el pago exitoso y habilita la activación de la suscripción.<br><br><strong>Escenario 2: Error durante el procesamiento del cobro</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando ocurre un error durante el cobro (tarjeta rechazada o datos inválidos),<br>Entonces el sistema no activa la suscripción y muestra el motivo del error dentro de la misma vista.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Activación de suscripción exitosa</strong><br>Dado que el cobro fue procesado correctamente,<br>Cuando el sistema confirma el pago,<br>Entonces activa el Plan Control, actualiza el estado de la suscripción a "Activa" y redirige al usuario al resumen de suscripción con acceso a funcionalidades premium.<br><br><strong>Escenario 2: Suscripción no activada por pago no confirmado</strong><br>Dado que el cobro no fue confirmado,<br>Cuando el sistema intenta activar la suscripción,<br>Entonces el Plan Control no se activa, la cuenta permanece en Plan Free y el usuario no accede a funcionalidades premium.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: resumen de suscripción mostrado correctamente</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando el sistema carga la información,<br>Entonces muestra los datos generales del plan actual y las acciones relacionadas.<br><br><strong>Escenario 2: Usuario con Plan Free por defecto</strong><br>Dado que el usuario solo tiene el Plan Free asignado por defecto,<br>Cuando carga la vista de "Suscripción",<br>Entonces el sistema informa el estado del Plan Free y la opción para actualizar al Plan Control.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Estado activa mostrado correctamente</strong><br>Dado que el usuario tiene una suscripción vigente de pago,<br>Cuando proporciona al resumen de "Suscripción",<br>Entonces el sistema muestra una etiqueta disponible con el estado "Activa".<br><br><strong>Escenario 2: Estado no activa mostrado correctamente</strong><br>Dado que el usuario tiene una suscripción cancelada, con cancelación programada o solo el Plan Free,<br>Cuando proporciona al resumen de "Suscripción",<br>Entonces el sistema muestra la etiqueta correspondiente al estado real del plan.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Renovación realizada correctamente</strong><br>Dado que el usuario tiene una suscripción activa o próxima a vencer,<br>Cuando solicita la operación «Renovar suscripción» y confirma la acción,<br>Entonces el sistema registra la renovación y actualiza la nueva fecha de vencimiento en el resumen.<br><br><strong>Escenario 2: Renovación no permitida</strong><br>Dado que el usuario se encuentra en Plan Free o no cuenta con una suscripción renovable,<br>Cuando solicita la operación «Renovar suscripción»,<br>Entonces el sistema muestra un mensaje indicando que primero debe contratar o reactivar un plan de pago.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Solicitud de cancelación registrada correctamente</strong><br>Dado que el usuario tiene una suscripción activa,<br>Cuando solicita la operación «Solicitar cancelación» y confirma la acción,<br>Entonces el sistema registra la solicitud y mantiene el acceso hasta la fecha de vencimiento.<br><br><strong>Escenario 2: Usuario cancela la operación antes de confirmar</strong><br>Dado que el usuario inició el proceso de cancelación,<br>Cuando solicita la operación «Volver» o cierra el diálogo antes de confirmar,<br>Entonces el sistema no registra la cancelación y la suscripción continúa sin cambios.<br><br><strong>Escenario 3: Mantener plan vigente</strong><br>Dado que el usuario visualiza el diálogo de confirmación para cancelar su suscripción,<br>Cuando solicita la operación «Mantener plan»,<br>Entonces el sistema cierra el diálogo, no registra ninguna solicitud de cancelación y conserva el Plan Control activo con su fecha de renovación original.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Cancelación ejecutada correctamente</strong><br>Dado que existe una solicitud de cancelación registrada y la fecha de vencimiento ha sido alcanzada,<br>Cuando el sistema procesa el fin del periodo,<br>Entonces la suscripción de pago es cancelada, el acceso premium es retirado y la cuenta vuelve automáticamente al Plan Free.<br><br><strong>Escenario 2: Suscripción aún dentro del periodo vigente</strong><br>Dado que la fecha de vencimiento aún no ha llegado,<br>Cuando el sistema verifica el estado,<br>Entonces la suscripción continúa activa, mantiene acceso premium y conserva el estado "Cancelación programada" hasta el final del periodo.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Registro de método de pago iniciado</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita la operación «Agregar método de pago»,<br>Entonces el sistema solicita los datos necesarios del medio de pago.<br><br><strong>Escenario 2: Método de pago registrado correctamente</strong><br>Dado que el usuario completa los datos requeridos del método de pago y solicita "Guardar método de pago",<br>Cuando el sistema valida la información,<br>Entonces el método queda asociado a la suscripción y se muestra en el resumen como método disponible para futuros cobros.<br><br><strong>Escenario 3: Método de pago inválido o cancelado</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando el sistema valida la acción,<br>Entonces no registra cambios y mantiene el estado anterior del método de pago.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Datos fiscales disponibles</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita la operación «Completar datos»,<br>Entonces el sistema solicita los datos fiscales requeridos para la facturación de la suscripción.<br><br><strong>Escenario 2: Datos fiscales guardados correctamente</strong><br>Dado que el usuario completa los dato fiscales obligatorios y solicita "Guardar datos fiscales",<br>Cuando el sistema valida la información,<br>Entonces registra los datos y actualiza la categoría mostrando que la información fiscal está completa.<br><br><strong>Escenario 3: Datos fiscales incompletos o inválidos</strong><br>Dado que el usuario deja dato obligatorios vacíos o proporciona un documento inválido,<br>Cuando solicita "Guardar datos fiscales",<br>Entonces el sistema no guarda la información, identifica los datos con error y muestra un mensaje de validación.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Historial descargado correctamente</strong><br>Dado que existen eventos registrados en la actividad de la suscripción,<br>Cuando el usuario solicita la operación «Descargar historial»,<br>Entonces el sistema genera y descarga un archivo con el historial de actividad disponible para el usuario.<br><br><strong>Escenario 2: Historial sin actividad suficiente</strong><br>Dado que la suscripción aún no tiene eventos relevantes registrados,<br>Cuando el usuario solicita "Descargar historial",<br>Entonces el sistema muestra un mensaje indicando que no hay actividad suficiente para descargar.<br><br><strong>Escenario 3: Error al generar descarga</strong><br>Dado que ocurre un error al preparar el archivo,<br>Cuando el usuario intenta descargar el historial,<br>Entonces el sistema muestra un mensaje de error y mantiene disponible el acción para volver a intentarlo.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Búsqueda con autocompletado y validación por peso</strong><br>Dado que el cajero cuenta con los datos y permisos necesarios,<br>Cuando el texto coincide con un producto del inventario,<br>Entonces el sistema muestra una lista de sugerencias en tiempo real; al seleccionar un producto con tipo "Weight Product", el sistema cierra el buscador y abre el diálogo "Registrar Peso".<br><br><strong>Escenario 2: Búsqueda con autocompletado y validación por cantidad</strong><br>Dado que el cajero escribe en el dato de búsqueda,<br>Cuando selecciona un producto con tipo "Unit Product" de la lista de sugerencias,<br>Entonces el sistema cierra el buscador y abre el diálogo "Registrar Cantidad".<br><br><strong>Escenario 3: Producto no encontrado</strong><br>Dado que el cajero proporciona un término que no coincide con ningún producto del inventario,<br>Cuando el sistema evalúa las coincidencias,<br>Entonces la lista de sugerencias muestra el mensaje "Producto no encontrado" y no permite seleccionar ningún ítem.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Confirmación de cantidad unitaria</strong><br>Dado que el diálogo "Registrar Cantidad" está abierto y muestra el nombre del producto y el stock disponible,<br>Cuando el cajero usa el teclado numérico del diálogo para ingresar un número entero (p. ej. "3") y solicita "Confirmar cantidad",<br>Entonces el sistema calcula el subtotal (precio × 3), cierra el diálogo y añade el ítem al ticket de venta con nombre, cantidad y subtotal disponible.<br><br><strong>Escenario 2: Validación de stock insuficiente por cantidad</strong><br>Dado que el diálogo "Registrar Cantidad" está abierto,<br>Cuando el cajero proporciona una cantidad mayor al stock disponible del producto y solicita "Confirmar cantidad",<br>Entonces el sistema muestra una alerta de "Stock insuficiente" dentro del diálogo y no añade el producto al ticket, manteniendo el diálogo abierto para que el cajero corrija la cantidad.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Captura automática con balanza IoT</strong><br>Dado que el diálogo "Registrar Peso" está abierto y el endpoint "/api/v1/iot-scale" retorna connected: true,<br>Cuando el sistema obtiene la lectura de la balanza,<br>Entonces muestra el peso en el dato del diálogo; después de 800 ms de mostrar el valor, el sistema confirma automáticamente y añade el producto al ticket de venta sin que el cajero deba pulsar ningún acción.<br><br><strong>Escenario 2: Registro de peso manual (sin balanza)</strong><br>Dado que el diálogo "Registrar Peso" está abierto y el endpoint "/api/v1/iot-scale" retorna connected: false,<br>Cuando el cajero usa el teclado decimal del diálogo para ingresar el peso observado físicamente y solicita "Confirmar Peso",<br>Entonces el sistema calcula el subtotal (precio/kg × peso), cierra el diálogo y añade el producto al ticket.<br><br><strong>Escenario 3: Validación de stock insuficiente por peso</strong><br>Dado que el diálogo "Registrar Peso" está abierto,<br>Cuando el peso ingresado o capturado es mayor al stock disponible en kg del producto,<br>Entonces el sistema muestra una alerta "Stock insuficiente" dentro del diálogo y no añade el producto al ticket.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Actualización del detalle y monto total</strong><br>Dado que se han añadido productos al ticket de venta,<br>Cuando el sistema procesa cada ítem de la lista y calcula automáticamente el subtotal multiplicando el precio por la cantidad o peso y suma todos los subtotales,<br>Entonces el sistema muestra el desglose detallado y el monto total acumulado de la venta en la contenido.<br><br><strong>Escenario 2: Eliminación de un ítem del detalle</strong><br>Dado que un producto ya se encuentra registrado en el ticket de venta,<br>Cuando el cajero solicita el ícono de basurero (eliminar) que aparece junto al ítem,<br>Entonces el sistema elimina el producto del ticket de forma inmediata y recalcula el subtotal y el conteo de ítems sin requerir confirmación adicional.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Selección de método de pago exitosa</strong><br>Dado que el ticket de venta tiene al menos un producto,<br>Cuando el cajero selecciona "Efectivo" o Tarjeta / Yape / Plin (digital),<br>Entonces el sistema registra el medio de pago seleccionado; el método "digital" agrupa Tarjeta, Yape y Plin como un único canal y lo registra como ingreso digital en la caja.<br><br><strong>Escenario 2: Intento de finalización sin método de pago</strong><br>Dado que el cajero ha terminado de agregar productos al ticket pero no seleccionó método de pago,<br>Cuando solicita "Finalizar Venta",<br>Entonces el sistema muestra el mensaje "Por favor, seleccione un método de pago" que desaparece automáticamente después de 3 segundos, y no procesa la venta.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Procesamiento exitoso del cierre de venta</strong><br>Dado que el ticket de venta tiene al menos un producto y el método de pago está seleccionado,<br>Cuando el cajero solicita "Finalizar Venta",<br>Entonces el sistema registra la venta en el endpoint "/api/v1/sales", actualiza el resumen de caja en "/api/v1/cash-registers" sumando el monto al canal correspondiente, y muestra el diálogo "Venta Exitosa"; el diálogo se cierra automáticamente después de 2 segundos o manualmente con el acción "X", y el ticket queda vacío listo para una nueva venta.<br><br><strong>Escenario 2: Bloqueo por ticket vacío</strong><br>Dado que el cajero cuenta con los datos y permisos necesarios,<br>Cuando solicita "Finalizar Venta",<br>Entonces el sistema muestra el mensaje "No hay productos en el ticket" que desaparece automáticamente después de 3 segundos, y no procesa la venta.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Cancelación exitosa del ticket</strong><br>Dado que el cajero cuenta con los datos y permisos necesarios,<br>Cuando solicita el acción de cancelar venta,<br>Entonces el sistema elimina todos los ítems del ticket, limpia el método de pago seleccionado y deja la contenido lista para una nueva venta sin registrar ninguna transacción.<br><br><strong>Escenario 2: Cancelación con ticket vacío</strong><br>Dado que el cajero no tiene productos en el ticket,<br>Cuando el sistema evalúa la acción de cancelar,<br>Entonces no realiza ninguna operación ya que el ticket ya está vacío.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Actualización del acumulado por método de pago</strong><br>Dado que se ha finalizado una venta exitosamente,<br>Cuando el sistema procesa el registro de la transacción con método "CASH" o "DIGITAL",<br>Entonces el sistema suma el monto al dato totalCash o totalDigital del registro de caja del día en el endpoint "/api/v1/cash-registers" y actualiza el resumen de caja en tiempo real de forma inmediata.<br><br><strong>Escenario 2: Visualización del total general de ingresos</strong><br>Dado que existen ingresos registrados en efectivo y/o digital,<br>Cuando el comerciante visualiza el resumen "Resumen de Caja" en la información de Ventas,<br>Entonces el sistema muestra "Efectivo", Tarjeta / Yape / Plin y "Total del Día" como la suma de ambos canales, expresados en la moneda configurada en las preferencias del perfil.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Visualización dinámica de ingresos operativos</strong><br>Dado que el cajero cuenta con los datos y permisos necesarios,<br>Cuando finaliza transacciones de forma sucesiva,<br>Entonces el sistema actualiza automáticamente los valores de "Efectivo", Tarjeta / Yape / Plin y "Total del día" en el resumen "Resumen de Caja" sin requerir una actualización manual.<br><br><strong>Escenario 2: Carga de saldos persistidos al ingresar a ventas</strong><br>Dado que el comerciante tiene ventas registradas en el día,<br>Cuando accede o regresa a la información "Ventas" de la aplicación móvil,<br>Entonces el sistema consulta el endpoint "/api/v1/cash-registers" y muestra los saldos acumulados del día correspondiente a la fecha actual, sin perder datos al navegar entre secciones o actualizar manualmente la información.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Vinculación mediante enlace seguro</strong><br>Dado que el comerciante no tiene una cuenta vinculada y WhatsApp Business está instalado en su dispositivo,<br>Cuando solicita "Vincular WhatsApp",<br>Entonces Entreprenly abre un enlace seguro en WhatsApp Business para autorizar la conexión y permite regresar a la aplicación móvil.<br><br><strong>Escenario 2: Vinculación alternativa mediante código QR</strong><br>Dado que el comerciante elige vincular su cuenta mediante un código QR,<br>Cuando escanea desde WhatsApp Business el código mostrado por Entreprenly en otro dispositivo y el sistema confirma la conexión,<br>Entonces registra la vinculación, activa el chatbot y habilita la visualización de conversaciones en la aplicación móvil.<br><br><strong>Escenario 3: Vinculación fallida por código QR expirado</strong><br>Dado que el comerciante está en el proceso de vinculación de WhatsApp Business,<br>Cuando el código QR expira sin haber sido escaneado y el sistema detecta que la sesión no fue establecida en el tiempo límite,<br>Entonces el sistema descarta el código expirado, muestra un mensaje indicando que el código expiró y genera un nuevo código QR automáticamente.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Estado activo cuando la cuenta está vinculada</strong><br>Dado que el comerciante tiene una cuenta vinculada,<br>Cuando accede a la categoría de chatbot,<br>Entonces el sistema muestra el estado como activo junto al número vinculado.<br><br><strong>Escenario 2: Estado desconectado cuando la sesión expiró</strong><br>Dado que la sesión ha expirado o fue cerrada externamente,<br>Cuando el comerciante accede a la categoría de chatbot,<br>Entonces el sistema muestra el estado como desconectado y habilita la opción de volver a vincular.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Conversaciones cargadas cuando existe actividad</strong><br>Dado que el comerciante tiene su WhatsApp Business vinculado,<br>Cuando accede a la categoría de chatbot,<br>Entonces el sistema muestra la lista de conversaciones ordenada por la más reciente con el último mensaje disponible.<br><br><strong>Escenario 2: Mensaje informativo cuando no hay conversaciones</strong><br>Dado que ningún cliente ha iniciado una conversación con el bot,<br>Cuando el comerciante accede a la categoría,<br>Entonces el sistema indica que aún no existen conversaciones registradas.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Mensaje enviado correctamente al cliente</strong><br>Dado que el comerciante selecciona una conversación activa y redacta un mensaje,<br>Cuando confirma el envío,<br>Entonces el sistema envía el mensaje al cliente a través de WhatsApp y lo registra en el hilo de conversación.<br><br><strong>Escenario 2: Envío bloqueado cuando el mensaje está vacío</strong><br>Dado que el comerciante no ha redactado ningún contenido,<br>Cuando intenta confirmar el envío,<br>Entonces el sistema no procesa el mensaje y mantiene la conversación sin cambios.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Bot informa disponibilidad del producto solicitado</strong><br>Dado que el cliente envía el nombre de un producto,<br>Cuando el sistema lo encuentra con stock mayor a cero,<br>Entonces el bot responde con el nombre, el precio y el stock disponible, y ofrece agregarlo al pedido.<br><br><strong>Escenario 2: Bot registra selección confirmada por el cliente</strong><br>Dado que el bot informó la disponibilidad del producto,<br>Cuando el cliente confirma la cantidad deseada,<br>Entonces el sistema registra la selección en el pedido en curso y consulta si desea agregar más productos.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Bot sugiere alternativas cuando el producto no existe</strong><br>Dado que el producto solicitado no se encuentra o tiene stock igual a cero,<br>Cuando el sistema verifica la disponibilidad,<br>Entonces el bot informa que no está disponible y presenta alternativas con stock.<br><br><strong>Escenario 2: Bot notifica cuando el inventario completo está agotado</strong><br>Dado que todos los productos tienen stock igual a cero,<br>Cuando el sistema verifica la disponibilidad general,<br>Entonces el bot informa que no hay productos disponibles e invita al cliente a intentarlo más tarde.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Bot envía resumen y solicita confirmación</strong><br>Dado que el cliente indicó todos los productos y su dirección de entrega,<br>Cuando indica que no desea agregar más,<br>Entonces el sistema genera un resumen con productos, cantidades, total y dirección, y solicita confirmación.<br><br><strong>Escenario 2: Sistema registra pedido tras confirmación del cliente</strong><br>Dado que el bot envió el resumen del pedido,<br>Cuando el cliente confirma que es correcto,<br>Entonces el sistema registra el pedido con estado pendiente y envía las instrucciones de pago.<br><br><strong>Escenario 3: Solicitar dirección de entrega al cliente</strong><br>Dado que el cliente confirmó los productos de su pedido,<br>Cuando el chatbot verifica que aún no se registró una dirección de entrega,<br>Entonces solicita al cliente que indique su dirección antes de continuar y no genera el resumen del pedido hasta que el cliente la proporcione.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Bot envía instrucciones tras confirmación del pedido</strong><br>Dado que el cliente confirmó su pedido y el stock fue validado,<br>Cuando el sistema procesa la confirmación,<br>Entonces el bot envía el número Yape/Plin del comerciante, el monto total y el número de pedido como referencia.<br><br><strong>Escenario 2: Sistema registra el evento de instrucción enviada</strong><br>Dado que el bot entrega las instrucciones de pago,<br>Cuando el sistema confirma la entrega del mensaje,<br>Entonces registra el evento con marca de tiempo para trazabilidad.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Sistema registra comprobante recibido y notifica al comerciante</strong><br>Dado que el cliente realizó el pago por Yape o Plin,<br>Cuando envía el comprobante al chatbot,<br>Entonces el sistema lo registra, actualiza el estado del pedido a pendiente de validación y notifica al comerciante.<br><br><strong>Escenario 2: Bot envía recordatorio ante ausencia de reporte</strong><br>Dado que el cliente recibió las instrucciones de pago,<br>Cuando transcurren treinta minutos sin que reporte el comprobante,<br>Entonces el sistema envía un recordatorio y mantiene el pedido en estado esperando pago.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Comerciante visualiza comprobante y detalles del pedido</strong><br>Dado que el cliente reportó su comprobante,<br>Cuando el comerciante revisa el pedido,<br>Entonces el sistema muestra el comprobante, el monto y los detalles del pedido asociado.<br><br><strong>Escenario 2: Sistema registra validación manual al aprobar el pago</strong><br>Dado que el comerciante verifica que el comprobante es correcto,<br>Cuando aprueba el pago,<br>Entonces el sistema registra la validación con marca de tiempo y continúa el flujo de confirmación.<br><br><strong>Escenario 3: Sistema notifica al cliente al rechazar el pago</strong><br>Dado que el comerciante detecta que el comprobante es incorrecto,<br>Cuando lo rechaza indicando el motivo,<br>Entonces el sistema registra el rechazo y el bot notifica al cliente con los pasos a seguir.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Bot confirma al cliente que el pago fue aprobado</strong><br>Dado que el comerciante aprueba el comprobante,<br>Cuando el sistema actualiza el estado del pedido,<br>Entonces el bot envía al cliente un mensaje confirmando que el pago fue recibido y el pedido está en proceso.<br><br><strong>Escenario 2: Bot informa al cliente que el pago fue rechazado</strong><br>Dado que el comerciante rechaza el comprobante,<br>Cuando el sistema actualiza el estado,<br>Entonces el bot informa al cliente que el pago no fue validado, indica el motivo y solicita que reintente.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Sistema actualiza inventario al confirmar el pedido</strong><br>Dado que el comerciante aprueba el comprobante de pago,<br>Cuando el sistema confirma el pedido,<br>Entonces actualiza el estado a confirmado y descuenta la cantidad correspondiente del stock de cada producto.<br><br><strong>Escenario 2: Sistema sincroniza peso con balanza IoT para productos por peso</strong><br>Dado que el pedido incluye productos vendidos por peso,<br>Cuando el sistema descuenta el stock,<br>Entonces actualiza el peso disponible registrado en la balanza IoT.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Sistema crea registro de venta al confirmar pedido</strong><br>Dado que el pedido ha sido confirmado tras la validación del pago,<br>Cuando el sistema procesa el cierre de la transacción,<br>Entonces crea un registro de venta con monto total, método de pago, productos vendidos y marca de tiempo.<br><br><strong>Escenario 2: Sistema separa ingresos digitales de los ingresos en efectivo</strong><br>Dado que el método de pago fue Yape o Plin,<br>Cuando el sistema registra la venta,<br>Entonces asocia el monto al canal de pagos digitales, manteniéndolo separado del efectivo en caja.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Bot notifica al cliente sobre stock insuficiente</strong><br>Dado que el cliente solicita una cantidad mayor al stock disponible,<br>Cuando el sistema valida el inventario,<br>Entonces el bot informa qué producto no tiene stock suficiente y ofrece ajustar la cantidad o eliminarlo del pedido.<br><br><strong>Escenario 2: Sistema actualiza el pedido con la nueva cantidad</strong><br>Dado que el bot informó al cliente sobre el stock insuficiente,<br>Cuando el cliente confirma una nueva cantidad menor o igual al stock disponible,<br>Entonces el sistema actualiza el pedido y continúa el flujo de forma normal.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Sistema cancela el pedido y libera el stock al expirar el tiempo</strong><br>Dado que el cliente recibió las instrucciones de pago,<br>Cuando transcurren sesenta minutos sin que reporte el comprobante,<br>Entonces el sistema cancela el pedido, libera el stock reservado y notifica al cliente.<br><br><strong>Escenario 2: Sistema registra el evento de cancelación para trazabilidad</strong><br>Dado que el pedido es cancelado por expiración,<br>Cuando el sistema actualiza el estado,<br>Entonces registra el evento de cancelación con el motivo y marca de tiempo correspondientes.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Sistema revierte el estado del pedido al rechazar el comprobante</strong><br>Dado que el comerciante identifica un comprobante sospechoso o incorrecto,<br>Cuando lo rechaza indicando el motivo,<br>Entonces el sistema devuelve el pedido al estado "esperando pago" y el bot notifica al cliente.<br><br><strong>Escenario 2: Sistema alerta al comerciante ante rechazos repetidos del mismo cliente</strong><br>Dado que el mismo cliente presenta comprobantes rechazados en dos ocasiones consecutivas,<br>Cuando el sistema detecta el patrón,<br>Entonces alerta al comerciante y bloquea el pedido para revisión manual.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Visitante visualiza la propuesta de valor al cargar la página</strong><br>Dado que el visitante accede a la landing page,<br>Cuando la página termina de cargar,<br>Entonces el sistema muestra el headline principal, la propuesta de valor y los beneficios clave del producto.<br><br><strong>Escenario 2: Visitante accede a la categoría de funcionalidades</strong><br>Dado que el visitante navega por la landing page,<br>Cuando llega a la categoría de funcionalidades,<br>Entonces el sistema presenta las características principales: chatbot WhatsApp, inventario, balanza IoT y resumen móvil financiero.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Creación exitosa de pedido</strong><br>Dado que un cliente autorizado envía una solicitud de creación con datos válidos,<br>Cuando el servidor valida el cuerpo,<br>Entonces el sistema responde con HTTP 201, retorna el ID del pedido, el estado pendiente y la marca de tiempo.<br><br><strong>Escenario 2: Actualización de estado de pedido existente</strong><br>Dado que un cliente autorizado envía una solicitud de actualización con un estado válido,<br>Cuando el servidor procesa la solicitud,<br>Entonces el sistema responde con HTTP 200 y retorna el pedido actualizado.<br><br><strong>Escenario 3: Solicitud sobre pedido inexistente</strong><br>Dado que un cliente autorizado referencia un ID de pedido inexistente,<br>Cuando el servidor busca el recurso,<br>Entonces el sistema responde con HTTP 404 indicando que el pedido no fue encontrado.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Aprobación de pago con descuento de stock</strong><br>Dado que un cliente autorizado envía una solicitud de aprobación,<br>Cuando el servidor procesa la validación,<br>Entonces el sistema responde con HTTP 200, actualiza el pedido a confirmado y descuenta el stock correspondiente.<br><br><strong>Escenario 2: Rechazo de pago con registro de motivo</strong><br>Dado que un cliente autorizado envía una solicitud de rechazo con un motivo,<br>Cuando el servidor procesa el rechazo,<br>Entonces el sistema responde con HTTP 200 y registra el motivo en el historial del pago.<br><br><strong>Escenario 3: Solicitud sobre pago inexistente</strong><br>Dado que un cliente autorizado referencia un ID de pago inexistente,<br>Cuando el servidor busca el recurso,<br>Entonces el sistema responde con HTTP 404 indicando que el pago no fue encontrado.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Registro exitoso</strong><br>Dado que el usuario proporciona un email no registrado y una contraseña válida,<br>Cuando envía los datos,<br>Entonces el sistema crea la cuenta, asigna automáticamente el Plan Free, envía un email de verificación y muestra un mensaje de confirmación.<br><br><strong>Escenario 2: Email ya registrado</strong><br>Dado que el usuario proporciona un email que ya existe,<br>Cuando envía los datos,<br>Entonces el sistema muestra un mensaje de error indicando que el email ya está en uso.<br><br><strong>Escenario 3: Datos inválidos</strong><br>Dado que la contraseña no cumple los requisitos mínimos,<br>Cuando envía los datos,<br>Entonces el sistema muestra los errores de validación sin crear la cuenta.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Verificación exitosa</strong><br>Dado que el usuario selecciona un enlace de verificación válido desde su correo,<br>Cuando Entreprenly valida el token mediante un enlace profundo,<br>Entonces la cuenta queda activa y la aplicación muestra la información "Inicio".<br><br><strong>Escenario 2: Token expirado</strong><br>Dado que el token ha expirado,<br>Cuando el sistema intenta validarlo,<br>Entonces muestra un mensaje de error y ofrece la opción de reenviar el email de verificación.<br><br><strong>Escenario 3: Token inválido</strong><br>Dado que el token está malformado,<br>Cuando el sistema intenta procesarlo,<br>Entonces muestra un mensaje de error indicando que el enlace no es válido.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Inicio de sesión exitoso</strong><br>Dado que el usuario proporciona credenciales válidas,<br>Cuando envía los datos,<br>Entonces el sistema genera un JWT, inicia la sesión y responde con los datos iniciales de la cuenta móvil.<br><br><strong>Escenario 2: Credenciales inválidas</strong><br>Dado que el usuario proporciona una contraseña incorrecta,<br>Cuando envía los datos,<br>Entonces el sistema muestra un mensaje de error sin revelar cuál dato es incorrecto.<br><br><strong>Escenario 3: Cuenta bloqueada por intentos fallidos</strong><br>Dado que el usuario ha fallado 5 intentos consecutivos,<br>Cuando intenta iniciar sesión nuevamente,<br>Entonces el sistema bloquea la cuenta y notifica al usuario por email.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: OAuth exitoso con cuenta nueva</strong><br>Dado que el usuario selecciona una cuenta desde el proveedor de identidad de Google del dispositivo y esta no se encuentra registrada,<br>Cuando Google autoriza el acceso,<br>Entonces el sistema crea una nueva cuenta vinculada al proveedor e inicia la sesión en la aplicación móvil.<br><br><strong>Escenario 2: OAuth exitoso con cuenta existente</strong><br>Dado que el usuario selecciona una cuenta de Google cuyo email ya está registrado,<br>Cuando Google devuelve el token,<br>Entonces el sistema vincula el proveedor a la cuenta existente e inicia la sesión en la aplicación móvil.<br><br><strong>Escenario 3: OAuth denegado por el usuario</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando el flujo es interrumpido,<br>Entonces el sistema redirige al usuario a la información de login sin crear ninguna cuenta.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Reset exitoso</strong><br>Dado que el usuario solicita el restablecimiento con un email registrado y abre el enlace recibido,<br>Cuando Entreprenly valida el token mediante un enlace profundo y el usuario confirma la nueva contraseña,<br>Entonces actualiza la contraseña, invalida las sesiones anteriores y muestra la información de inicio de sesión.<br><br><strong>Escenario 2: Token de reset expirado</strong><br>Dado que el usuario accede al enlace después de que el token ha expirado,<br>Cuando el sistema intenta validarlo,<br>Entonces muestra un mensaje de error y solicita generar un nuevo enlace.<br><br><strong>Escenario 3: Email no registrado</strong><br>Dado que el usuario solicita el reset con un email que no existe,<br>Cuando envía los datos,<br>Entonces el sistema responde con un mensaje genérico sin confirmar ni negar la existencia del email.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Cierre de sesión exitoso</strong><br>Dado que el usuario selecciona la opción de cerrar sesión,<br>Cuando el sistema procesa la solicitud,<br>Entonces revoca el JWT activo y muestra la información de inicio de sesión.<br><br><strong>Escenario 2: Intento de acceso tras cerrar sesión</strong><br>Dado que el usuario ha cerrado su sesión y el token ha sido revocado,<br>Cuando intenta abrir una información protegida,<br>Entonces el sistema rechaza la solicitud y muestra la información de inicio de sesión.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Visualización exitosa</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando el sistema carga los datos,<br>Entonces muestra nombre, bio, foto de perfil, email y preferencias actuales del usuario.<br><br><strong>Escenario 2: Sesión expirada</strong><br>Dado que la sesión del usuario ha expirado,<br>Cuando intenta acceder a la categoría de perfil,<br>Entonces el sistema redirige al login.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Actualización exitosa</strong><br>Dado que el usuario edita su nombre y/o bio con datos válidos,<br>Cuando guarda los cambios,<br>Entonces el sistema actualiza los datos y muestra el perfil con la información nueva.<br><br><strong>Escenario 2: dato obligatorio vacío</strong><br>Dado que el usuario deja el dato de nombre vacío,<br>Cuando intenta guardar,<br>Entonces el sistema muestra un error de validación sin guardar los cambios.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Selección exitosa desde la galería</strong><br>Dado que el usuario concede acceso a sus imágenes y selecciona una con formato y tamaño permitidos,<br>Cuando confirma la selección,<br>Entonces el servicio de almacenamiento guarda el archivo y muestra la nueva foto en el perfil.<br><br><strong>Escenario 2: Captura exitosa con la cámara</strong><br>Dado que el usuario concede permiso para usar la cámara,<br>Cuando toma y confirma una fotografía,<br>Entonces Entreprenly la carga y actualiza la imagen del perfil.<br><br><strong>Escenario 3: Permiso denegado</strong><br>Dado que el usuario deniega el permiso de cámara o galería,<br>Cuando intenta elegir ese origen,<br>Entonces la aplicación explica cómo habilitarlo desde la configuración del dispositivo y conserva la foto actual.<br><br><strong>Escenario 4: Formato de imagen no permitido</strong><br>Dado que el usuario intenta subir un archivo con formato no soportado,<br>Cuando el sistema valida el archivo,<br>Entonces muestra un mensaje de error indicando los formatos aceptados sin guardar el archivo.<br><br><strong>Escenario 5: Tamaño de archivo excedido</strong><br>Dado que el usuario intenta subir una imagen que supera el tamaño máximo (5120 KB),<br>Cuando el sistema valida el archivo,<br>Entonces muestra un mensaje de error indicando el límite de tamaño.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Cambio de email exitoso</strong><br>Dado que el usuario solicitó cambiar su email a uno no registrado previamente,<br>Cuando confirma el cambio desde el enlace enviado y el sistema valida el token,<br>Entonces se actualiza el email y queda marcado como verificado.<br><br><strong>Escenario 2: Nuevo email ya en uso</strong><br>Dado que el usuario proporciona un email que ya pertenece a otra cuenta,<br>Cuando intenta guardar el cambio,<br>Entonces el sistema muestra un mensaje de error sin actualizar el email.<br><br><strong>Escenario 3: Confirmación desde enlace expirado</strong><br>Dado que el usuario selecciona un enlace de confirmación expirado desde su dispositivo,<br>Cuando el sistema valida el token,<br>Entonces muestra un mensaje de error y ofrece reenviar el email de confirmación.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Cambio exitoso</strong><br>Dado que el usuario proporciona su contraseña actual correcta y una nueva contraseña válida,<br>Cuando guarda el cambio,<br>Entonces el sistema actualiza la contraseña e invalida todas las sesiones activas excepto la actual.<br><br><strong>Escenario 2: Contraseña actual incorrecta</strong><br>Dado que el usuario proporciona una contraseña actual incorrecta,<br>Cuando intenta guardar,<br>Entonces el sistema muestra un error de validación sin actualizar la contraseña.<br><br><strong>Escenario 3: Nueva contraseña no cumple requisitos</strong><br>Dado que el usuario proporciona una nueva contraseña que no cumple los requisitos mínimos,<br>Cuando intenta guardar,<br>Entonces el sistema muestra los requisitos incumplidos sin aplicar el cambio.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Guardado exitoso de preferencias</strong><br>Dado que el usuario concedió el permiso de notificaciones y activa o desactiva tipos de aviso,<br>Cuando guarda los cambios,<br>Entonces el sistema almacena las preferencias y las aplica a las notificaciones push futuras.<br><br><strong>Escenario 2: Permiso de notificaciones denegado</strong><br>Dado que el permiso de notificaciones está desactivado en el dispositivo,<br>Cuando el usuario intenta habilitar las notificaciones push,<br>Entonces Entreprenly explica por qué las necesita y ofrece abrir la configuración del sistema sin cambiar el permiso automáticamente.<br><br><strong>Escenario 3: Sin cambios realizados</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando sale de la categoría,<br>Entonces el sistema mantiene las preferencias anteriores sin alteración.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Número de teléfono registrado correctamente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando solicita "Verificar teléfono",<br>Entonces el sistema registra el número y muestra confirmación del envío del código de verificación.<br><br><strong>Escenario 2: Formato de teléfono inválido</strong><br>Dado que el comerciante proporciona un número con menos de 7 dígitos o caracteres no permitidos,<br>Cuando el sistema valida el dato,<br>Entonces muestra un mensaje de error de formato y no envía el código de verificación.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Resumen de ventas cargado correctamente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema carga la información,<br>Entonces el sistema devuelve el indicador "Ingresos del día" con el total acumulado, el total en efectivo y el total digital correspondiente a Yape, Plin o tarjeta.<br><br><strong>Escenario 2: Sin ventas registradas en el día</strong><br>Dado que existe al menos una venta registrada,<br>Cuando el sistema carga la información,<br>Entonces el sistema informa S/0.00 en el total del día, efectivo y digital.<br><br><strong>Escenario 3: Acceso al funcionalidad de ventas</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando solicita el enlace "Ir a Ventas",<br>Entonces el sistema navega a la información "Ventas" de la aplicación móvil.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Chatbot conectado con actividad reciente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema consulta el estado,<br>Entonces se muestra el estado "WhatsApp Conectado" y el texto que indica que el chatbot está activo y recibiendo mensajes.<br><br><strong>Escenario 2: Chatbot desconectado</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema consulta el estado,<br>Entonces se muestra el estado "WhatsApp Desconectado", una descripción del problema y el acción "Conectar ahora".<br><br><strong>Escenario 3: Pedidos pendientes disponible desde el estado del chatbot</strong><br>Dado que existen pedidos esperando validación de pago,<br>Cuando el sistema consulta el estado del chatbot,<br>Entonces se muestra un aviso con el número de pedidos pendientes.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Alertas de inventario mostradas en la información de Inicio</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema consulta el estado,<br>Entonces se muestra un banner de alerta y una lista con el producto afectado y el tipo de alerta correspondiente.<br><br><strong>Escenario 2: Sin alertas activas de inventario</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema consulta el estado,<br>Entonces la categoría de alertas muestra el mensaje "Todo en orden" e indica que no hay alertas de inventario.<br><br><strong>Escenario 3: Acceso al inventario desde una alerta</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando solicita "Ver inventario",<br>Entonces el sistema navega a la información "Lotes" de la aplicación móvil.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Pedidos pendientes mostrados correctamente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema consulta el estado,<br>Entonces se muestra un aviso en el estado del chatbot con el número de pedidos esperando validación.<br><br><strong>Escenario 2: Sin pedidos pendientes</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema consulta el estado,<br>Entonces no se muestra el aviso de pedidos pendientes.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Pedidos recientes mostrados correctamente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema consulta el estado,<br>Entonces se muestran los pedidos recientes con número de pedido, fecha, monto total y estado actual.<br><br><strong>Escenario 2: Sin pedidos registrados en el día</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema consulta el estado,<br>Entonces la categoría de pedidos recientes muestra el mensaje "Sin pedidos todavía".<br><br><strong>Escenario 3: Resumen por estado</strong><br>Dado que existen pedidos recientes,<br>Cuando el sistema carga la categoría,<br>Entonces muestra contadores de pedidos aprobados y pendientes.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Acceso directo navega al funcionalidad correcto</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando solicita un acceso directo,<br>Entonces el sistema lo redirige al funcionalidad correspondiente entre Ventas, Chatbot, Pedidos, Inventario o Ayuda.<br><br><strong>Escenario 2: Accesibilidad de accesos directos</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando recorre los accesos directos,<br>Entonces cada control anuncia el nombre del funcionalidad de destino y dispone de un área táctil accesible.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Centro de soporte cargado correctamente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema consulta el estado de soporte,<br>Entonces se muestran el buscador de ayuda, artículos más consultados, todos los artículos, categorías y acceso directo a reportar un problema.<br><br><strong>Escenario 2: Centro de soporte sin artículos disponibles</strong><br>Dado que el comerciante accede al centro de soporte y no existen artículos de ayuda configurados,<br>Cuando el sistema consulta el estado,<br>Entonces se muestra un mensaje indicando que el contenido de ayuda no está disponible aún y se mantiene disponible la opción de reportar un problema.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Búsqueda con resultados encontrados</strong><br>Dado que el comerciante está en el centro de soporte,<br>Cuando proporciona una palabra clave en el buscador y confirma la búsqueda,<br>Entonces el sistema muestra la cantidad de resultados encontrados, el término buscado, las categorías relacionadas y los artículos que coinciden con la consulta.<br><br><strong>Escenario 2: Búsqueda sin resultados</strong><br>Dado que el comerciante proporciona un término en el buscador y no existen artículos que coincidan con la búsqueda,<br>Cuando el sistema procesa la consulta,<br>Entonces se muestra un mensaje indicando que no se encontraron resultados y se sugiere reformular la búsqueda o reportar el problema directamente.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Artículo cargado correctamente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema carga el artículo,<br>Entonces se muestra el breadcrumb de ayuda, categoría, título, tiempo de lectura, pasos del artículo y artículos relacionados cuando existan.<br><br><strong>Escenario 2: Artículo marcado como útil o no útil</strong><br>Dado que el comerciante leyó el artículo de ayuda,<br>Cuando selecciona la opción "¿Te fue útil este artículo?" y elige "Sí" o "No",<br>Entonces el sistema registra la respuesta y si elige "No", muestra la opción de reportar el problema directamente.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Reporte enviado correctamente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando solicita la operación «Enviar reporte»,<br>Entonces el sistema registra el reporte y muestra una confirmación indicando que fue recibido.<br><br><strong>Escenario 2: Intento de envío con dato incompletos</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando solicita la operación «Enviar reporte»,<br>Entonces el sistema no registra el reporte y muestra mensajes de error indicando los dato que deben completarse.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Confirmación mostrada correctamente</strong><br>Dado que el comerciante envió un reporte de problema exitosamente,<br>Cuando el sistema procesa el envío,<br>Entonces se muestra una información de confirmación con el número de ticket generado, fecha, resumen del reporte y la opción de volver al centro de soporte.<br><br><strong>Escenario 2: Error en el envío del reporte</strong><br>Dado que el comerciante intentó enviar un reporte y ocurre un error en el sistema durante el procesamiento,<br>Cuando el sistema detecta el fallo,<br>Entonces no se genera el ticket y se muestra un mensaje indicando que hubo un error e invita a intentarlo nuevamente.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: acceso a funcionalidad correcto</strong><br>Dado que el usuario se encuentra dentro de la aplicación móvil,<br>Cuando selecciona una opción del opciones de acceso,<br>Entonces el sistema habilita la consulta del detalle.<br><br><strong>Escenario 2: Acceso al perfil desde el bloque de usuario</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita dicho bloque,<br>Entonces el sistema navega a la información "Perfil" de la aplicación móvil.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Cambio de idioma a español</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita la opción "ES",<br>Entonces el sistema actualiza el idioma activo a español mediante el servicio de traducción y refresca los textos traducibles de la contenido.<br><br><strong>Escenario 2: Cambio de idioma a inglés</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita la opción "EN",<br>Entonces el sistema actualiza el idioma activo a inglés y mantiene resaltada la opción seleccionada.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Enlace profundo inválido</strong><br>Dado que el usuario abre un enlace profundo cuyo destino no existe o ya no está disponible,<br>Cuando Entreprenly procesa el enlace,<br>Entonces muestra una información informativa con una acción para regresar al Inicio.<br><br><strong>Escenario 2: Destino inicial sin especificar</strong><br>Dado que el usuario autenticado abre la aplicación sin un destino específico,<br>Cuando el sistema resuelve la acceso inicial,<br>Entonces muestra automáticamente la información "Inicio".</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Visualización del Hero completo</strong><br>Dado que el comerciante carga la URL principal de la landing page,<br>Cuando la página termina de renderizar,<br>Entonces el sistema muestra el mensaje "Controla inventario, pedidos y cobros de tu negocio" y el acción de acción principal disponible en información.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: categoría de funciones disponible al consultar el contenido</strong><br>Dado que el comerciante consulta el contenido en la landing page,<br>Cuando llega a la categoría de funciones,<br>Entonces el sistema muestra los iconos y las descripciones detalladas de cada uno de los 4 pilares clave: Inventario, Finanzas, Chatbot y Balanza IoT.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: opciones de planes mostradas correctamente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando visualiza las opciones de planes,<br>Entonces el sistema muestra el costo mensual y la lista de funcionalidades incluidas en cada nivel: Plan Free y Plan Control.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Acordeón de FAQ funciona correctamente</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando selecciona una pregunta,<br>Entonces el sistema expande la respuesta correspondiente de forma fluida y colapsa las demás preguntas abiertas.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Aplicación instalada</strong><br>Dado que el comerciante tiene Entreprenly instalado en su dispositivo móvil,<br>Cuando selecciona el acción "Ingresar" de la Landing Page,<br>Entonces el sistema inicia el proceso de autenticación de la aplicación mediante un enlace profundo.<br><br><strong>Escenario 2: Aplicación no instalada</strong><br>Dado que el comerciante no tiene Entreprenly instalado,<br>Cuando selecciona el acción "Ingresar",<br>Entonces la Landing Page muestra las opciones disponibles para descargar la aplicación móvil.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Acceso a la descarga desde el llamado a la acción</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando la Landing Page identifica el sistema operativo del dispositivo,<br>Entonces muestra el enlace de descarga compatible para instalar Entreprenly.<br><br><strong>Escenario 2: Registro con la aplicación instalada</strong><br>Dado que Entreprenly ya está instalado en el dispositivo,<br>Cuando el comerciante selecciona "Empezar gratis",<br>Entonces el sistema abre mediante un enlace profundo la información de registro de una cuenta nueva.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Eliminar producto correctamente</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita "Eliminar",<br>Entonces el producto se elimina exitosamente.<br><br><strong>Escenario 2: Validación al eliminar lote</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando solicita "Eliminar",<br>Entonces saldrá un mensaje de error de no haber seleccionado un producto.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Generación de token al iniciar sesión</strong><br>Dado que un usuario envía credenciales válidas al endpoint de autenticación,<br>Cuando el servidor las valida,<br>Entonces responde con HTTP 200 y retorna un token JWT firmado con su tiempo de expiración.<br><br><strong>Escenario 2: Acceso autorizado con token válido</strong><br>Dado que el cliente incluye un token JWT válido en la cabecera Authorization,<br>Cuando solicita un recurso protegido,<br>Entonces el servidor valida el token y responde con HTTP 200 y los datos solicitados.<br><br><strong>Escenario 3: Rechazo de token inválido o ausente</strong><br>Dado que el cliente solicita un recurso protegido sin token o con un token inválido o expirado,<br>Cuando el servidor evalúa la solicitud,<br>Entonces responde con HTTP 401 indicando que la autenticación es requerida.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Construcción de imagen Docker</strong><br>Dado que el código fuente está en la rama principal,<br>Cuando se ejecuta la construcción definida en el Dockerfile,<br>Entonces el sistema genera una imagen ejecutable del backend sin errores.<br><br><strong>Escenario 2: Pipeline de integración continua exitoso</strong><br>Dado que se realiza un push o merge a la rama integradora,<br>Cuando el pipeline de GitHub Actions se ejecuta,<br>Entonces compila el proyecto, ejecuta las pruebas y construye la imagen automáticamente.<br><br><strong>Escenario 3: Fallo de build detiene el despliegue</strong><br>Dado que la compilación o las pruebas fallan,<br>Cuando el pipeline se ejecuta,<br>Entonces el sistema detiene el proceso y no publica una imagen defectuosa.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Persistencia de entidad de dominio</strong><br>Dado que se ejecuta una operación de creación sobre un agregado,<br>Cuando el repositorio JPA persiste la entidad,<br>Entonces los datos quedan almacenados y son recuperables por su identificador.<br><br><strong>Escenario 2: Generación automática del esquema</strong><br>Dado que la aplicación arranca con un nuevo bounded context,<br>Cuando se inicializa la capa de persistencia,<br>Entonces el sistema crea las tablas correspondientes según el mapeo definido.<br><br><strong>Escenario 3: Aislamiento entre contextos</strong><br>Dado que dos bounded contexts definen entidades distintas,<br>Cuando se persisten sus datos,<br>Entonces cada contexto gestiona sus tablas sin interferir con los demás.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Búsqueda de lotes por nombre de producto</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando proporciona el nombre de un producto en el dato de búsqueda,<br>Entonces el sistema filtra en tiempo real y muestra únicamente las tarjetas de los productos cuyo nombre coincide con el texto ingresado.<br><br><strong>Escenario 2: Búsqueda de lotes por marca</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando proporciona la marca de un producto en el dato de búsqueda,<br>Entonces el sistema filtra y muestra las tarjetas cuyos productos coinciden con esa marca.<br><br><strong>Escenario 3: Búsqueda sin coincidencias</strong><br>Dado que el usuario proporciona un término en el dato de búsqueda,<br>Cuando ningún producto coincide con el texto,<br>Entonces el sistema no muestra tarjetas hasta que se ajuste o se limpie la búsqueda.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Métodos de pago disponibles</strong><br>Dado que el comerciante tiene uno o más métodos de pago registrados,<br>Cuando consulta los medios de pago registrados,<br>Entonces el sistema muestra un diálogo con las tarjetas disponibles, identifica el método principal y permite seleccionar otro medio de pago como principal.<br><br><strong>Escenario 2: registro de un nuevo medio de pago</strong><br>Dado que el comerciante se encuentra en el diálogo de métodos de pago,<br>Cuando solicita "Agregar método de pago", completa los datos requeridos y guarda los cambios,<br>Entonces el sistema registra el nuevo método, lo muestra en la lista y lo deja disponible para pagos y renovaciones.</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Historial cargado con las ventas del día</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando el sistema consulta el endpoint "/api/v1/sales" filtrando por la fecha seleccionada,<br>Entonces muestra en el resumen "Historial de ventas" cada transacción ordenada de la más reciente a la más antigua, indicando la hora, el método de pago, la cantidad de productos y el total formateado en la moneda configurada en el perfil.<br><br><strong>Escenario 2: Consulta de otro día mediante el selector de fecha</strong><br>Dado que el comerciante cuenta con los datos y permisos necesarios,<br>Cuando selecciona una fecha distinta en el selector de fecha,<br>Entonces el sistema consulta las ventas correspondientes a ese día de negocio y actualiza la lista sin actualizar manualmente la información.<br><br><strong>Escenario 3: Día sin ventas o carga en curso</strong><br>Dado que el comerciante selecciona un día sin ventas registradas,<br>Cuando el sistema termina de consultar la información después de mostrar el estado "Cargando ventas…",<br>Entonces presenta el mensaje "No hay ventas registradas para este día".</td></tr>
  </tbody>
</table>
...
<table width="100%" style="width:100%; table-layout:fixed;">
  <tbody>
    ...
    <tr><th colspan="4">Acceptance Criteria</th></tr>
    <tr><td colspan="4"><strong>Escenario 1: Apertura del detalle de la venta</strong><br>Dado que existe al menos una venta registrada,<br>Cuando selecciona una venta de la lista,<br>Entonces el sistema abre el sistema informa la fecha, la hora, el método de pago, cada producto con su cantidad o peso, el precio unitario, el subtotal y el total de la venta.<br><br><strong>Escenario 2: Regreso al historial</strong><br>Dado que el usuario cuenta con los datos y permisos necesarios,<br>Cuando el comerciante utiliza la acción de regresar,<br>Entonces el sistema vuelve al historial sin modificar la venta consultada.</td></tr>
  </tbody>
</table>
